...
public class Q5Parser {
	 ...
	 */
	public Q5Parser(Reader reader) throws IOException {
		if (reader == null) {
	...
	public static void main(String[] args) {
		process("(((10)))");
		process("10 + 20 - 30 * 40 / 60");
		process("10 + -(20 - +30) + +-0");
	}

	private static void process(String input) {
		try {
			Q5Parser parser = new Q5Parser(new StringReader(input));
	 ...
	 *     AddRest(a)::= '+' MultExpr$b AddRest(a+b)$r  ; r
	 *              |  '-' MultExpr$b AddRest(a-b)$r  ; r
	 *              | empty ; a
	 *              
	 *    MultExpr ::= UnaryExpr$a MultRest(a)$r	; r
	 * MultRest(a) ::= '*' UnaryExpr$b MultRest(a*b)$r ; r
	 *              |  '/' UnaryExpr$b MultRest(a/b)$r ; r
	 *              | empty ; a
	 * 
