...
public class Q3Parser {
	 ...
	 */
	public Q3Parser(Reader reader) throws IOException {
		if (reader == null) {
	...
	private static void process(String input) {
		try {
			Q3Parser parser = new Q3Parser(new StringReader(input));
	 ...
	 * Expression ::= Value$a Rest(a)$r ; r
	 *    Rest(a) ::= '+' Value$b ; new Add(a, b)
	 *             |  '-' Value$b ; new Subtract(a, b)
	 *             |  '*' Value$b ; new Multiply(a, b)
	 *             |  '/' Value$b ; new Divide(a, b)
	 *             | empty
	 *      Value ::= NUMBER$t            ; new Value(t.image)
	 * &lt;/code&gt;
	 * </pre>
