...
public class Q2Parser {
	 ...
	 */
	public Q2Parser(Reader reader) throws IOException {
		if (reader == null) {
	...
	private static void process(String input) {
		try {
			Q2Parser parser = new Q2Parser(new StringReader(input));
	 ...
	 * <pre>
	 * &lt;code&gt;
	 * Expression ::= '-' Value$a         ; new Minus(a)
	 *             |  '-' Value$a Value$b ; new Subtract(a, b)
	 *             |  Value$v             ; v
	 *      Value ::= NUMBER$t            ; new Value(t.image)
	 * 
	 * Expression ::= '-' Value$a Rest$r ;new Subtract(a, r)
	 *             |  Value$v             ; v
	 * 	Rest ::= Value$b				; new Minus(b)			
	 * 		| empty
	 *      Value ::= NUMBER$t            ; new Value(t.image)
	 * 
	 * 
